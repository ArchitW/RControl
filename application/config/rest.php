...
| 'html'        HTML using the table libraries in CodeIgniter
| 'php':        Uses var_export()
...
| 'libraries' Use a authentication libraries
|
...
|--------------------------------------------------------------------------
|
| If libraries authentication is used define the class and function name
|
| The function should accept two parameters: class->function($username, $password)
| In other cases override the function _perform_library_auth in your controller
|
| For digest authentication the libraries function should return already a stored
